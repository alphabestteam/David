...
function getScoreSentence(alphabeticalScore) {
    switch (alphabeticalScore){
        case "A+": return "Perfect!"
        case "A": return "Amazing!"
        case "B": return "Nicely done!"
        case "C": return "This is fine!"
        case "D": return "You can do better!"
        case "E": return "Moed B is an option!"
        case "F": return "Moed B is a must!"
    }
}
